...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    public String REGGID = "id";
	private Controller aController = null;
    public String MESSAGE="";
    public static final String userstr = "userr";
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        String message = intent.getExtras().getString("NS_MSG");
    ...
    private static void generateNotification(Context context, String message) {
        int icon = R.drawable.news;
        long when = System.currentTimeMillis();
        NotificationManager notificationManager = (NotificationManager)
                context.getSystemService(Context.NOTIFICATION_SERVICE);
        Notification notification = new Notification(icon, message, when);
        
        String title = "News hunt";
        Intent notificationIntent = new Intent(context, Home.class);
        notificationIntent.putExtra("exam",message);

        SharedPreferences sharedPreferences = context.getSharedPreferences(MyPREFERENCES, context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(userstr, message);
        editor.commit();
